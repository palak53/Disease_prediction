...
import joblib as jb
model = jb.load('pal.sav')
model2 = jb.load('kartik.sav')
     ...
     return render(request,'patient/checkdisease/checkdisease.html', {"list2":alphabaticsymptomslist})
      ...
      if (inputno == 0 ) :
        ...
        predicted_disease = predicted[0]
         ...
         #trial model 2
        predicted_2 = model2.predict(inputtest)
        print("predicted disease is : ")
        print(predicted_2)

        y_pred_22 = model2.predict_proba(inputtest)
        confidencescore2=y_pred_22.max() * 100
        print(" confidence score of : = {0} ".format(confidencescore2))

        confidencescore2 = format(confidencescore2, '.0f')
        predicted_disease2 = predicted[0]
        ...
        return JsonResponse({'predicteddisease': predicted_disease ,'confidencescore':confidencescore , "consultdoctor": consultdoctor,'predicteddisease2': predicted_disease2 ,'confidencescore2':confidencescore2})
